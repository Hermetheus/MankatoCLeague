import hockeyStandings from "./hockeyStandings";

const upperBracket = hockeyStandings.Playoffs.map((match) => {
...
const lowerBracket = hockeyStandings.Playoffs.map((match) => {
...
export { doubleBracketData, upperBracket, lowerBracket, testBracket };
